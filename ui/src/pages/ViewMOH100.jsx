...
export default function ViewMOH100() {
  ...
  let getPatientDetails = async id => {
    setOpen(false);
    let data = await (
      await fetch(`${apiHost}/referrals/${id}`, {
        method: 'GET',
        headers: {
              ...
              <CardContent>
                {patient ? (
                  <>
                    ...
                    <Typography>
                      <b>Age: </b>
                      {timeSince(new Date(patient.dob))}
                    </Typography>
                    <Typography>
                      <b>Phone: </b>
                      {patient.phone}
                    ...
                    <Typography>
                      <b>Main Problems: </b>
                      {patient.data.mainProblems}
                    </Typography>
                    <Typography>
                      <b>Reasons for Referral:</b>{' '}
                      {patient.data.reasonsForReferral}
                    </Typography>
                    <Typography>
                      <b>Treatment Given: </b>
                      {patient.data.treatmentGiven ?? 'N/A'}
                    </Typography>
                    <Typography>
                      <b>Comments: </b>
                      {patient.data.comments ?? 'N/A'}
                    </Typography>
                    <Typography>
                      <b>Referral Time: </b>
                      {timeSince(new Date(patient.createdAt))}
                    </Typography>
                    <p></p>
                    <Divider />
                    <p></p>
                    ...
                    <Typography>
                      <b>Ward: </b>
                      {patient.residence.ward}
                    </Typography>
                    <Typography>
                      <b>Sub-County: </b>
                      {patient.residence.subCounty}
                    </Typography>
                    <Typography>
                      <b>County: </b>
